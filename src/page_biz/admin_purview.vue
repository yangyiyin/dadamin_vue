    ...
    <div class="fillcontain">
        ...
        <!--<div class="table_container" style="padding-bottom: 0">-->
            ...
            <!--<moreinfo defaultheight="auto" :hide_divider_btn="true">-->
                ...
                <!--<el-button style="float: right;margin-left: 40px;" icon="el-icon-plus" type="success" @click="goto_edit_admin_purview(0)">添加节点</el-button>-->
        ...
        <div>
            ...
            <div style="display: flex">
                ...
                <div>
                    <el-button  style="" type="primary" @click="goto_edit_admin_purview(0)">添加节点<i class="el-icon-right"></i></el-button>
                </div>
            </div>
        </div>
